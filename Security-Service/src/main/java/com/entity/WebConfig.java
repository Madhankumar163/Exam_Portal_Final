...
*
* @Bean FilterRegistrationBean corsFilter() { UrlBasedCorsConfigurationSource
...
* config.setMaxAge(MAX_AGE); source.registerCorsConfiguration("/**", config);
...
* SpringSecurityFilter bean.setOrder(CORS_FILTER_ORDER); return bean; } }
*/